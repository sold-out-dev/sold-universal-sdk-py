...
def parse_pixel_html_var(src: str) -> int:
    ...
    if match:
        ...
        raise Exception("universal-sdk: pixel HTML var not found")
...
def parse_pixel_script_url(src: str) -> tuple[str, str]:
    ...
    if match:
        ...
        raise Exception("universal-sdk: script URL not found")
...
def parse_pixel_script_var(src: str) -> str:
    ...
    if not index_match:
        raise Exception("universal-sdk: script var not found")
