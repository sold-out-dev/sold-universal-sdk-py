...
class SecCptChallenge:
    ...
    def _parse_challenge_data(src: str) -> SecCptChallengeData:
        ...
        if not challenge_match:
            raise Exception("universal-sdk: Challenge data not found.")
    ...
    def _parse_duration(src: str) -> int:
        ...
        if not duration_match:
            raise Exception("universal-sdk: Duration not found.")

        try:
            duration = int(duration_match.group(1))
        except ValueError as e:
            raise Exception(f"universal-sdk: Invalid duration value: {e}")
    ...
    def _parse_challenge_path(src: str) -> str:
        ...
        if not page_match:
            raise Exception("universal-sdk: Challenge path not found.")
    ...
    def generate_sec_cpt_payload(self, sec_cpt_cookie: str) -> str:
        ...
        if sec == sec_cpt_cookie:
            raise Exception("universal-sdk: Malformed sec_cpt cookie.")
